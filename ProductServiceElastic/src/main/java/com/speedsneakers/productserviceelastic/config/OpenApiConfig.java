...
public class OpenApiConfig {
    ...
    @Bean
    public OpenAPI productServiceElasticOpenApi() {
        return new OpenAPI()
                .info(new Info()
                        .title("Product Service Elastic API")
                        .description("Servicio de gestión de productos respaldado por Elasticsearch de la aplicación tienda react")
                        .version("v1"))
