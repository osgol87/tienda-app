package com.speedsneakers.productserviceelastic.security;
...
class JwtAuthenticationFilterTest {
    ...
    private static final String SECRET = "test-secret-key-para-pruebas-unitarias-del-filtro-jwt";
